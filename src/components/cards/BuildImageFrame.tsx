 ...
 * whatever the source canvas dimensions are; the dark panel, a near-black
 * vignette localized behind the case (which hides the light edge fringe
 * transparent cutouts tend to carry) and a drop shadow that hugs the case
 * silhouette keep it from looking like a cutout floating on nothing.
 */
